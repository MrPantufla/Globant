...
public class CincoEstrellas extends CuatroEstrellas{
    ...
    public CincoEstrellas(int cantSalonesConferencia, int cantSuites, int cantLimosinas, int cantHabitaciones, int numCamas, int cantPisos, char tipoGimnasio, String nombreRestaurante, int capacidadRestaurante, int precioHabitacion, String nombre, String direccion, String gerente) {
        super(cantHabitaciones, numCamas, cantPisos, tipoGimnasio, nombreRestaurante, capacidadRestaurante, precioHabitacion, nombre, direccion, gerente);
